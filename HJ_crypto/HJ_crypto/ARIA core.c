 ...
 *      void Crypt(const u8 *plainText, int numberOfRounds, const u8 *roundKeys, u8 *cipherText);
 *      int EncKeySetup(const u8 *masterKey, u8 *roundKeys, int keyBits);
 *      int DecKeySetup(const u8 *masterKey, u8 *roundKeys, int keyBits);
...
// Diffusion Layer
void DL(const uint8_t* i, uint8_t* o)
{
	uint8_t T;
